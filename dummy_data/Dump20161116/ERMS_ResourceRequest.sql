...
CREATE TABLE `ResourceRequest` (
  ...
  CONSTRAINT `resourcerequest_ibfk_1` FOREIGN KEY (`ResourceID`) REFERENCES `Resource` (`ResourceID`),
  CONSTRAINT `resourcerequest_ibfk_2` FOREIGN KEY (`IncidentID`) REFERENCES `Incident` (`IncidentID`)
...
INSERT INTO `ResourceRequest` VALUES (1,3,'2015-03-02',36),(1,4,'2015-03-02',38),(1,5,'2015-03-02',40);
